...
var MessageMiddleware = /** @class */ (function () {
    function MessageMiddleware() {
        var _this = this;
        this.isChatAvailable = (0, express_async_handler_1.default)(function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            var chatId, chat;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        chat = _a.sent();
                        if (!chat) {
                            throw new CustomError_1.default('Not Found', "This chat couldn't found", 404);
                        }
                        next();
                        return [2 /*return*/];
                }
