...
var requiresUser = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var user, userService, isUserAvailable;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, userService.isUserAvailable({ _id: user._id })];
            case 1:
                isUserAvailable = _a.sent();
                if (!isUserAvailable) {
                    return [2 /*return*/, next(new CustomError_1.default('Not Found', "This user couldn't found", 404))];
                }
