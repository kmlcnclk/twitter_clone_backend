...
var MessageController = /** @class */ (function () {
    function MessageController() {
        var _this = this;
        this.createMessage = (0, express_async_handler_1.default)(function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var userId, _a, chatId, content, data, message;
